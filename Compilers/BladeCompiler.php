...
namespace Satupersen\View\Compilers;
...
class BladeCompiler extends Compiler implements CompilerInterface
{
    ...
    public function if($name, callable $callback)
    {
        ...
        $this->directive($name, function ($expression) use ($name) {
            return $expression !== ''
                    ? "<?php if (\Satupersen\Support\Facades\Blade::check('{$name}', {$expression})): ?>"
                    : "<?php if (\Satupersen\Support\Facades\Blade::check('{$name}')): ?>";
        });
        ...
        $this->directive('else'.$name, function ($expression) use ($name) {
            return $expression !== ''
                ? "<?php elseif (\Satupersen\Support\Facades\Blade::check('{$name}', {$expression})): ?>"
                : "<?php elseif (\Satupersen\Support\Facades\Blade::check('{$name}')): ?>";
        });
    ...
    public function aliasInclude($path, $alias = null)
    {
        ...
        $this->directive($alias, function ($expression) use ($path) {
            ...
            return "<?php echo \$__env->make('{$path}', {$expression}, \Satupersen\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>";
        });
    }
